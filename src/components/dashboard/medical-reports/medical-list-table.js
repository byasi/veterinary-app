...
const groupMedicalReports = (rawInvoices) => rawInvoices.reduce((acc, invoice) => {
...
const MedicalRow = (props) => {
  ...
  return (
    ...
    >
      <TableCell width="25%">
        <NextLink
          href="/dashboard/medical-reports/1"
          passHref
        >
          <Box
            component="a"
...
export const MedicalListTable = (props) => {
  const {
    group,
    invoices,
    invoicesCount,
  ...
  const groupedInvoices = group && groupMedicalReports(invoices);
