...
import { MedicalPDF } from '../../../components/dashboard/medical-reports/medical-pdfs';
import { MedicalPreview } from '../../../components/dashboard/medical-reports/medical-preview';
...
const MedicalDetails = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Medical Details | Vet App
        </title>
      </Head>
      <Box
        component="main"
      ...
      >
        <Container maxWidth="md">
          <Box sx={{ mb: 3 }}>
            ...
            >
              ...
              >
                ...
                <PDFDownloadLink
                  document={<MedicalPDF invoice={invoice} />}
                  fileName="invoice"
          ...
          <MedicalPreview invoice={invoice} />
        </Container>
      </Box>
      <Dialog
        fullScreen
