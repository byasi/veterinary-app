...
import { MedicalListFilters } from '../../../components/dashboard/medical-reports/medical-list-filter';
import { MedicalListTable } from '../../../components/dashboard/medical-reports/medical-list-table';
...
const MedicalListInner = styled('div',
...
const MedicalReports = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Medical Reports | Vet App
        </title>
      </Head>
      <Box
        component="main"
      ...
      >
        <MedicalListFilters
          ...
          open={openFilters}
        />
        <MedicalListInner open={openFilters}>
          <Box sx={{ mb: 3 }}>
            <Grid
              container
              spacing={3}
